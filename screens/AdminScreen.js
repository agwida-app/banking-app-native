          ...
          <ScrollView style={{padding:16}}>
            {renewModal && (
              <View style={s.renewInfo}>
                ...
                <Text style={s.renewInfoT}>📅 ينتهي حالياً: {fmt(renewModal.expiresAt)}</Text>
              </View>
            )}
        ...
        <View style={s.modalWrap}>
          ...
          <ScrollView style={{padding:16}}>
            <View style={s.infoBox}>
              <Text style={s.infoBoxT}>📧 {auth.currentUser?.email}</Text>
            </View>
...
const s = StyleSheet.create({
  ...
  deviceRow:     { flexDirection:'row', alignItems:'center', gap:8, paddingVertical:8, borderBottomWidth:1, borderBottomColor:'rgba(255,255,255,0.05)' },
  deviceNum:     { fontSize:12, color:'#8a9ab5', width:18, textAlign:'center' },
  ...
  infoBox:       { backgroundColor:'rgba(201,168,76,0.07)', borderRadius:10, padding:12, marginBottom:20, borderWidth:1, borderColor:'rgba(201,168,76,0.2)', alignItems:'center' },
  infoBoxT:      { fontSize:14, color:'#c9a84c', fontWeight:'600' },
